...
go get -v
GOARCH=amd64 GOOS=windows go build -o update-aws-ecs-service-amd64-windows.exe
zip update-aws-ecs-service-amd64-windows.zip update-aws-ecs-service-amd64-windows.exe
rm update-aws-ecs-service-amd64-windows.exe
mv update-aws-ecs-service-amd64-windows.zip ../../
cd ../../
...
go get -v
GOARCH=amd64 GOOS=windows go build -o enforce-aws-ecs-asg-launchconfig-amd64-windows.exe
zip enforce-aws-ecs-asg-launchconfig-amd64-windows.zip enforce-aws-ecs-asg-launchconfig-amd64-windows.exe
rm enforce-aws-ecs-asg-launchconfig-amd64-windows.exe
mv enforce-aws-ecs-asg-launchconfig-amd64-windows.zip ../../
cd ../../
